...
def get_pipeline() -> SolarPanelPipeline:
    ...
    if _pipeline_instance is None:
        ...
        drone_model = base_path / "yolo26m80k_weights_best.pt" # Or .onnx if preferred
        keras_model = base_path / "best_solar_model.keras"
        esrgan_model = base_path / "RealESRGAN_RealESRGAN_x4plus.pth"
        segformer_model = base_path / "final_weighted_model"
